...
parser.add_argument('--save_file', required=True,
              help='Path for file to save model and history')
parser.add_argument('--desc', default='VAE model', type=str,
...
torch.save({
    'config': args,
    'model_state': gmvae.network.state_dict(),
    'loss_history': history_loss,
}, f"checkpoint/{args.save_file}.pth")
